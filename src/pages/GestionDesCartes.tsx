	...
	<div className="good">
		...
		<MediaQuery minWidth={760}>
			<div className="style-nom-attributs">
				...
				<p className="nomjoueur">
					Nom
				</p>
				<p className="notejoueur ">
					Not
				</p>
				<p className="positionjoueur ">
					Post
				</p>
				<p className="paysjoueur ">
					Pay
				</p>
				<p className="dribblesjoueur ">
					Drib
				</p>
				<p className="vitessejoueur ">
					Vit
				</p>
				<p className="puissancejoueur ">
					For
				</p>
				<p className="defensejoueur ">
					Déf
				</p>
				<p className="passejoueur">
					Pass
				</p>
			</div>
		</MediaQuery>
		<MediaQuery minWidth={760}>
			{tabDisplayed?.map((player: Players, i) =>
			
			<div className="listPlayers" key={i}>
				<div className="style-attributs">
					<p className="joueur-attribut ">
						{player.firstName}
					</p>
					<p className="nomjoueur-attribut ">
						{player.lastName}
					</p>
					<p className="notejoueur-attribut ">
						{player.rate} 
					</p>
					<p className="positionjoueur-attribut ">
						{player.position} 
					</p>
					<p className="paysjoueur-attribut ">
						{player.country} 
					</p>
					<p className="dribblesjoueur-attribut ">
						{player.dribbles} 
					</p>
					<p className="vitessejoueur-attribut ">
						{player.speed} 
					</p>
					<p className="puissancejoueur-attribut ">
						{player.power} 
					</p>
					<p className="defensejoueur-attribut ">
						{player.defence} 
					</p>
					<p  className="passejoueur-attribut  ">
						{player.pass} 
					</p>
		...
		<div className='toRow'>
			<Row >
				<Toast className="to" onClose={() =>
					 setShow(false)} show={show} delay={3000}>
					<Toast.Header>
					...
					<Toast.Body>
						<div className="toast-choix">
							...
							<div className="toast-button">
								<p onClick={deletePlayer} className="toastText-oui">
									oui
								</p>
								<p onClick={noDelete} className="toastText-non">
									non
								</p>
							</div>
						</div>
		...
		<MediaQuery maxWidth={759}>
			<div className="style-nom-attributs">
				<p className="joueur-nom-Mobile">
					Pré
				</p>
				<p className="joueurMobile ">
					Nom
				</p>
				<p className="joueur-note-Mobile ">
					Not
				</p>
				<p className="joueur-position-Mobile">
					Post
				</p>
			</div>
		</MediaQuery>
